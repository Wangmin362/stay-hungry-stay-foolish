...
func TestTimeToTimestamp(t *testing.T) {
	fmt.Println(time.Date(2023, 9, 5, 17, 22, 4, 0, time.Local).Unix())
}

func TestTimestampToDate(t *testing.T) {
	tm := time.Unix(1702051200, 0)
...
func TestTenantConfig(t *testing.T) {
	key := fmt.Sprintf("/pop/product_config/mapping/%s", tenant)
	value := "1.0.7"
...
func TestCreateProduct(t *testing.T) {
	...
	switch product {
	case "dsg":
		value = `{"initialized":true,"auth_status":0,"max_rs":3,"capacity":null,"start_time":1693152000,"end_time":1701100800}`
	case "ucwi":
		value = `{"initialized":true,"auth_status":0,"max_rs":9,"capacity":{"user_count":null,"daily_query":0,"query_speed":1000,"max_bandwidth":null},"start_time":1693152000,"end_time":1702051200}`
	case "ucsslite":
	...
	case "swg":
		value = `{"initialized":true,"auth_status":0,"max_rs":7,"capacity":null,"start_time":1693152000,"end_time":1701100800}`
	case "dsa": //需要在UCSS集群上测试
		value = `{"initialized":true,"auth_status":1,"max_rs":1,"capacity":null,"start_time":1693152000,"end_time":1701100800}`
	case "tenantauth": //需要在UCSS集群上测试
		value = `{"initialized":true,"auth_status":1,"max_rs":1,"capacity":null,"start_time":1693152000,"end_time":1781100800}`
	default:
...
func TestSumilateVPNConnection(t *testing.T) {
	key := fmt.Sprintf("/tenant/state/%s/vpn/004", tenant)
